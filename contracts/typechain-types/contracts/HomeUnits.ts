...
export interface HomeUnitsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
  ...
  decodeFunctionResult(functionFragment: "makeRooms", data: BytesLike): Result;
...
export interface HomeUnits extends BaseContract {
  connect(runner?: ContractRunner | null): HomeUnits;
  waitForDeployment(): Promise<this>;

  interface: HomeUnitsInterface;
  ...
  makeRooms: TypedContractMethod<
    [
      to: AddressLike,
      homeIds: BigNumberish[],
      units: BigNumberish[],
      data: BytesLike
    ],
    [void],
